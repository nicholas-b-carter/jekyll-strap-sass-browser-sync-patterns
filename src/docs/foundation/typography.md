...
<div style="max-width: 650px; line-height: 1.8;">
    ...
    <hr>
    <p>Inventors are encouraged to search the BCBSM's patent database to see if a patent has already been filed or granted that is similar to your patent. Patents may be searched in the BCBSM Patent Full-Text and Image Database (PatFT). The BCBSM houses full text for patents issued from 1976 to the present and PDF images for all patents from 1790 to the present.</p>
